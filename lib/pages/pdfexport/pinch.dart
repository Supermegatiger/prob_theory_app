...
import 'package:prob_theory_app/pages/pdfexport/pdf/pdfexport.dart';
...
class PinchPage extends StatefulWidget {
  ...
  const PinchPage({Key? key, required this.options}) : super(key: key);
  @override
...
class _PinchPageState extends State<PinchPage> {
  ...
  void initState() {
    _pdfControllerPinch = PdfControllerPinch(
      document: PdfDocument.openData(makePdf(widget.options)),
    );
    super.initState();
  }
